...
export const communityBoardBudgetRequest = pgTable(
  "community_board_budget_request",
  {
    ...
    segmentOnStreet: text("segment_on_street"),
    segmentCrossStreetOne: text("segment_cross_street_one"),
    segmentCrossStreetTwo: text("segment_cross_street_two"),
    intersectionStreetOne: text("intersection_street_one"),
    intersectionStreetTwo: text("intersection_street_two"),
...
export const communityBoardBudgetRequestEntitySchema = z.object({
  ...
  segmentOnStreet: z.string().nullable(),
  segmentCrossStreetOne: z.string().nullable(),
  segmentCrossStreetTwo: z.string().nullable(),
  intersectionStreetOne: z.string().nullable(),
  intersectionStreetTwo: z.string().nullable(),
