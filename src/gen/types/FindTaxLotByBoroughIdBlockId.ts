...
export type FindTaxLotByBoroughIdBlockIdPathParams = {
  /**
...
export type FindTaxLotByBoroughIdBlockIdQueryParams = {
  /**
 ...
 */
export type FindTaxLotByBoroughIdBlockId200 = TaxLotBasicPage;
/**
 * @description Invalid client request
 */
export type FindTaxLotByBoroughIdBlockId400 = Error;
/**
 * @description Server side error
 */
export type FindTaxLotByBoroughIdBlockId500 = Error;
/**
 * @description An object containing a list of tax lots and pagination metadata for lots in a block. Optionally, results may be limited to lots matching a query.
 */
export type FindTaxLotByBoroughIdBlockIdQueryResponse = TaxLotBasicPage;
export type FindTaxLotByBoroughIdBlockIdQuery = {
  Response: FindTaxLotByBoroughIdBlockIdQueryResponse;
  PathParams: FindTaxLotByBoroughIdBlockIdPathParams;
  QueryParams: FindTaxLotByBoroughIdBlockIdQueryParams;
  Errors: FindTaxLotByBoroughIdBlockId400 | FindTaxLotByBoroughIdBlockId500;
};
