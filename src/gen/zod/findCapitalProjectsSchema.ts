 ...
 */
export const findCapitalProjects200Schema = capitalProjectPageSchema;

/**
 * @description Invalid client request
 */
export const findCapitalProjects400Schema = errorSchema;

/**
 * @description Server side error
 */
export const findCapitalProjects500Schema = errorSchema;

export const findCapitalProjectsQueryResponseSchema =
