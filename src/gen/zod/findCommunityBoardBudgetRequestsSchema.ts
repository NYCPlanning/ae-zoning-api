...
import { communityBoardBudgetRequestPageSchema } from "./communityBoardBudgetRequestPageSchema.ts";
 ...
 */
export const findCommunityBoardBudgetRequests200Schema =
  communityBoardBudgetRequestPageSchema;

/**
 * @description Invalid client request
 */
export const findCommunityBoardBudgetRequests400Schema = errorSchema;

/**
 * @description Server side error
 */
export const findCommunityBoardBudgetRequests500Schema = errorSchema;

export const findCommunityBoardBudgetRequestsQueryResponseSchema =
