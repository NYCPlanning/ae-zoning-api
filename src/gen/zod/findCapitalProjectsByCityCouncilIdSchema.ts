 ...
 */
export const findCapitalProjectsByCityCouncilId200Schema =
  capitalProjectPageSchema;

/**
 * @description Invalid client request
 */
export const findCapitalProjectsByCityCouncilId400Schema = errorSchema;

/**
 * @description Server side error
 */
export const findCapitalProjectsByCityCouncilId500Schema = errorSchema;

export const findCapitalProjectsByCityCouncilIdQueryResponseSchema =
