 ...
 */
export const findCommunityDistrictTiles400Schema = errorSchema;

/**
 * @description Server side error
 */
export const findCommunityDistrictTiles500Schema = errorSchema;

export const findCommunityDistrictTilesQueryResponseSchema =
