 ...
 */
export const findAgencies400Schema = errorSchema;

/**
 * @description Server side error
 */
export const findAgencies500Schema = errorSchema;

export const findAgenciesQueryResponseSchema = findAgencies200Schema;
