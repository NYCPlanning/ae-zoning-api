...
import { communityBoardBudgetRequestPolicyAreaSchema } from "./communityBoardBudgetRequestPolicyAreaSchema.ts";
 ...
 */
export const findCommunityBoardBudgetRequestPolicyAreas400Schema = errorSchema;

/**
 * @description Server side error
 */
export const findCommunityBoardBudgetRequestPolicyAreas500Schema = errorSchema;
