...
import { taxLotBasicPageSchema } from "./taxLotBasicPageSchema.ts";
import { z } from "zod";
 ...
 */
export const findTaxLots200Schema = taxLotBasicPageSchema;

/**
 * @description Invalid client request
 */
export const findTaxLots400Schema = errorSchema;

/**
 * @description Server side error
 */
export const findTaxLots500Schema = errorSchema;

export const findTaxLotsQueryResponseSchema = findTaxLots200Schema;
