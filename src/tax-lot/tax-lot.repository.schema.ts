...
export const findGeomFromGeoJSONRepoSchema = z.object({
  geom: geomSchema,
});
...
export const findGeomBufferRepoSchema = z.object({
  buffer: geomSchema,
});

export type FindGeomBufferRepo = z.infer<typeof findGeomBufferRepoSchema>;

export const checkGeomIsValidRepoSchema = z.object({
  valid: z.boolean(),
});

export type CheckGeomIsValidRepo = z.infer<typeof checkGeomIsValidRepoSchema>;

export const findMaximumInscribedCircleCenterRepoSchema = z.object({
  center: geomSchema,
});
